  ...
  <div class="bg-light container my-5 p-4 shadow-lg">
    ...
    <div class="mb-3 text-center">
      <h1 class="mb-3">
        ...
        <span class="ml-2">TABEL JENIS BAJU</span>
      </h1>
      <a href={{ route('jenisbaju.create') }}
      ...
      <tbody>
        @foreach ($jenis_bajus as $jenis_baju)
          <tr>
            ...
            <td>{{ $jenis_baju->jenis_baju }}</td>
            <td>
              <div class="d-flex gap-1">
                {{-- <a href={{ route('jenisbaju.edit', ['jenis_baju' => $jenis_baju->id]) }}
                  class="btn btn-sm btn-success"><i class="fa-solid fa-pen-to-square"></i></a> --}}
                <form action={{ route('jenisbajudestroy', ['jenisBaju' => $jenis_baju->id]) }}
                  method="post">
                  @csrf
                  @method('delete')
                  <button type="submit"
